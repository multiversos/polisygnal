    ...
    *,
    ...
    return "\n".join(
        [
            ...
            "11. Set research_mode to real_web, mock_structural, or manual.",
            "12. Use source_review_required=true when sources need human review.",
            "13. Return ONLY valid JSON following the response schema.",
            "",
            "## Quality Gate",
            "",
            "- PolySignal validates the response before ingesting findings, reports, or predictions.",
            "- Responses without real sources may be rejected or marked review_required.",
            "- mock_structural must not be presented as real web research.",
            "- manual responses require human review before ingest.",
            "- confidence_score can be adjusted down by PolySignal when source quality is weak.",
            "- Do not invent URLs, source_name values, statistics, or citations.",
            "- You can dry-run validation before ingesting:",
            "",
            "```powershell",
            ...
            "- Confirm research_mode is correct: real_web, mock_structural, or manual.",
            "- Confirm source_review_required is true when source review is needed.",
