...
function historyItemFromAnalysis(analysis: MarketAnalysis) {
  ...
  return {
    ...
    conditionId: analysis.links?.condition_id || analysis.market.condition_id || undefined,
    ...
    marketId: String(analysis.market.id),
    marketSlug: analysis.links?.polymarket_market_slug || analysis.market.slug || undefined,
    ...
    remoteId: analysis.market.polymarket_market_id || undefined,
